...
public class HashmapAdapter extends ArrayAdapter<String> implements Filterable {
    ...
    public HashmapAdapter(Context context, int resource, ArrayList<HashMap<String, String>> fullList) {
